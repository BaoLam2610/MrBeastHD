...
import com.lambao.mrbeast_music.databinding.FragmentOfflinePlaylistBinding
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.flow.collect

@AndroidEntryPoint
class OfflinePlaylistFragment :
    BaseVMFragment<FragmentOfflinePlaylistBinding, OfflinePlaylistViewModel>() {
    ...
    override fun getLayoutResId() = R.layout.fragment_offline_playlist

    override fun getViewModelClass() = OfflinePlaylistViewModel::class.java

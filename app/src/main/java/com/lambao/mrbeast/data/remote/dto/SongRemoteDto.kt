...
data class SongRemoteDto(
    ...
    @Expose @SerializedName("artists") val artists: List<ArtistRemoteDto>?,
    ...
    @Expose @SerializedName("artist") val artist: ArtistRemoteDto?,
    @Expose @SerializedName("position") val position: Long?,
    @Expose @SerializedName("order") val order: String?,
    @Expose @SerializedName("album") val album: AlbumRemoteDto?,
)
